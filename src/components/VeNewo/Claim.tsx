...
import veNewoRewardsPreviousAvaxMerkleRoot from 'constants/airdrop/june30AvaxRewardsMerkleRoot.json'
import veNewoRewardsPreviousEthMerkleRoot from 'constants/airdrop/june30EthRewardsMerkleRoot.json'
import veNewoRewardsFinalAvaxMerkleRoot from 'constants/airdrop/july06AvaxRewardsMerkleRoot.json'
import veNewoRewardsFinalEthMerkleRoot from 'constants/airdrop/july06EthRewardsMerkleRoot.json'
